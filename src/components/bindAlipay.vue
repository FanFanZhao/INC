<template>
    <div class="inp_wrap">
        ...
        <div class="inp-item">
            <div>支付宝账号</div>
            <input type="text" class="请输入支付宝账号" v-model="alipay">
        </div>
        <div>
        ...
        getInfo(){
            ...
            this.$http({
                ...
                headers: {'Authorization':  this.token}    
                    ...
                    console.log(res);
                    if(res.data.type == 'ok'){
                        this.name = res.data.message.alipay_name;
                        this.alipay = res.data.message.alipay_account;
                        this.src1 = res.data.message.alipay_qr_code;
                        this.isshow = false
                    }
                })
        }
